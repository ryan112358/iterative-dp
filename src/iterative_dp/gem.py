...
from iterative_dp.Util.util_gem import *
from iterative_dp.Util.qm import QueryManager

from iterative_dp.Util.gan.ctgan.models import Generator
from iterative_dp.Util.gan.ctgan.transformer import DataTransformer
...
class GEM(object):
    ...
    def fit(self, T, eps0, sensitivity, qm, real_answers,
        ...
        for t in tqdm(range(T)):
            ...
            EM_dist = softmax(2 * alpha * eps0 * score / (2 * sensitivity))
